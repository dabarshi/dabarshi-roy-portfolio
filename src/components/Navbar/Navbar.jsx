...
import logoIcon from '../../assets/Icons/icon-avator-64.png';
import { useState } from "react";


const Navbar = () => {
    const [openUserManu, setOpenUserMenu] = useState(false);
            ...
            <nav className="bg-white border-gray-200 dark:bg-gray-900">
                ...
                {/* Logo and Brand */}
                    <Link to="/" className="flex items-center">
                        <img src={logoIcon} className="h-8 mr-3" alt="man with cap logo" />
                        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Dabarshi</span>
                    </Link>
                    {/* User image and user dropdown section */}
                    <div className="flex relative items-center md:order-2">
                        <button onClick={() => setOpenUserMenu(!openUserManu)} type="button" className="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                            <span className="sr-only">Open user menu</span>
                            <img className="w-8 h-8 rounded-full" src="/docs/images/people/profile-picture-3.jpg" alt="user photo" />
                        </button>
                        {/*  Dropdown menu  */}
                        <div className={openUserManu ? "open-user-menu dark:bg-gray-700 dark:divide-gray-600" : "hide-user-menu dark:bg-gray-700 dark:divide-gray-600"} id="user-dropdown">
                        ...
                        <button onClick={() => setOpenMenu(!openMenu)} data-collapse-toggle="navbar-user" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-user" aria-expanded="false">
                    ...
                    <div className={openMenu ? "nav-item hidden":"nav-item flex"} id="navbar-user">
